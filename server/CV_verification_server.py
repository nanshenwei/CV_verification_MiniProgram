...
class MainHandler(tornado.web.RequestHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        if size / 1000.0 > 2000:
            ...
            self.write({
                'errcode': 1,
                'errmsg': "img size is too large"
                })
            return
        file_info = self.request.files['raw_img'][0]
        path = "./uploads/"
        ...
        #     output_img = open(output_path,'r')
        #     output_img_bytes = output_img.read()
        #     self.write(output_img_bytes)
